		...
		require("legendary").setup({
			...
			keymaps = {
				...
				},
				{
					...
					description = "Telescope choose project",
				},
				{
					"<leader>tv",
				...
				-- { "<leader>db", ":lua require('dap').toggle_breakpoint()<cr>", description = "DAP insert breakpoint" },
				{ "<leader>db", ":DapToggleBreakpoint<cr>", description = "DAP insert breakpoint" },
				-- { "<F2>", ":lua vim.lsp.codelens.run()<cr>", description = "Code lense (like run or debug)" },
				{ "<F4>", ":DapViewToggle<cr>", description = "DAP view toggle" },
				{ "<F5>", ":DapTerminate<cr>", description = "DAP terminate or exit debug session" },
				-- { "<F2>", ":DapViewToggle<cr>", description = "DAP view toggle" },
				...
				},
				{
					...
					description = "Lspsaga go to type definition",
				},
				{
					"<leader>sc",
				...
				},
				{
					...
					description = "Lspsaga buffer diagnostic",
				},
				{
					"<leader>lb",
					"<cmd>Lspsaga show_buffer_diagnostics<CR>",
				...
				},
				{
					...
					description = "Lspsaga workspace diagnostic",
				},
				{
					"[e",
				...
				},
				{
					...
					description = "Code lense (aka Super method)",
				},
				{
					"<A-k>",
					function()
				...
				{
					"zh",
					':lua require("ufo").peekFoldedLinesUnderCursor()<CR>',
					description = "Folded lines under cursor",
				},
				{
					"zg",
					':lua require("ufo.action").goNextClosedFold()<CR>',
					description = "Go to next closed fold",
				},
				{
					"zp",
					':lua require("ufo.action").goPreviousClosedFold()<CR>',
					description = "Go to previous closed fold",
				},
				{
					"<leader>F",
